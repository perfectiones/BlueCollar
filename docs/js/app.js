(() => {
    ...
    window.addEventListener("scroll", (function() {
        ...
        if (pixel > 122) headerFixed.classList.remove("hide"); else headerFixed.classList.add("hide");
    }));
    for (let i = 0; i < offer__block.length; i++) offer__block[i].addEventListener("click", (function() {
